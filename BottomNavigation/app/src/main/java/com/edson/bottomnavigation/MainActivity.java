package com.edson.bottomnavigation;
...
import com.edson.bottomnavigation.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.bottomNavigationView.setOnItemSelectedListener(item -> {
            ...
            else  if(item.getItemId() == R.id.subscriptions){ replaceFragment(new SubscriptionFragment());}
